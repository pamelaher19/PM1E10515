...
public class MainActivity extends AppCompatActivity { SQLiteConexion conexion = new SQLiteConexion(this, Operaciones.NameDatabase,null,1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spPais = (Spinner)findViewById(R.id.cbPais);
        foto = (ImageView) findViewById(R.id.imageView);

        Button btnGuardarContacto= (Button) findViewById(R.id.btnSalvar);
        btnTomarFoto = (Button) findViewById(R.id.btnTomarFoto);
        Button btnContactoSalvados = (Button)findViewById(R.id.btnContactosS);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getApplicationContext(), com.example.pm1e10515.Pais.class);
